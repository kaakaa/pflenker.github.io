...
That just about concludes this chapter on entering raw mode. In the next chapter, we'll do some more terminal input/output handling, and use that to draw to the screen and allow the user to move the cursor around.
